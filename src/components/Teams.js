...
const Teams = () => {
    return (
        ...
        <div className="flex flex-wrap">
            ...
            <div className="px-6">
                <img alt="..." src="https://demos.creative-tim.com/notus-js/assets/img/team-1-800x800.jpg" className="shadow-lg rounded-full mx-auto max-w-120-px"/>
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-8">
            <div className="px-6">
                <img alt="..." src="https://demos.creative-tim.com/notus-js/assets/img/team-3-800x800.jpg" className="shadow-lg rounded-full mx-auto max-w-120-px"/>
                <div className="pt-6 text-center">
